<nav role="navigation" aria-label="Section Navigation" class="nav navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="submenuCollapse">
        <div class="list-wrapper"> 
            <!-- com.omniupdate.div label="navigation" group="navigation" button="781" path="/apply/_navigation.inc" -->
            <!-- ouc:editor csspath="/_resources/ou/editor/css/navigation.css" width="950"/ -->
            <h3><a href="/future_students/index.php">Future Students</a></h3>
            <ul>
              ...
              <li><a href="/academic_departments/programs.php">Programs of Study</a></li>
              <li><a href="/admissions_records/residence-requirements.php">Residence Requirements</a></li>
              <li><a href="/admissions_records/student-helpdesk.php">Student Helpdesk</a></li>
              <li><a href="/asbg/index.php">Student Life</a></li>
              <li class="last"><a href="/cashier_services/index.php">Tuition &amp; Fees</a></li>
            </ul>
            <!-- /com.omniupdate.div --> 
          </div>
    </div> 
